...
mail_de_contacto = "entidades.intermedias@vicentelopez.gov.ar"
# Carga de datos.
...
# parámetros. 
ui <- dashboardPage(
dashboardHeader(title = paste0("Mapa interactivo de Organizaciones de la Sociedad Civil - Vicente López (",nrow(datos),')')),
...
column(3,box("",width='100%',
             ...
             a(actionBttn(inputId = "ContactMe", label = "Contacto", 
                            icon = icon("envelope", lib = "font-awesome"),
                          color= "success", style="bordered"),
               href=paste("mailto",mail_de_contacto,sep=":"), target="_new"),
             HTML("</center>")
)),
